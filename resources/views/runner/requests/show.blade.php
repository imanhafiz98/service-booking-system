                        ...
                        <div class="tab-pane py-5 py-xl-10 fade" id="wizard4" role="tabpanel" aria-labelledby="wizard4-tab">
                            <div class="row justify-content-center">
                                <div class="col-xxl-6 col-xl-8">
                                    ...
                                    <h5 class="card-title">Review the payment type</h5>
                                    <div class="form-group">
                                        <label class="small mb-1" for="inputUsername">Payment Type</label>
                                        <input class="form-control" name="price" id="exampleFormControlInput1" type="text" value="{{ $req->payment->type }}" readonly />
                                    </div>
