    ...
    <main>
        ...
        <div class="container">
            <div class="text-center mb-5">
                <div class="display-4 text-primary mb-2">Submit your request now.</div>
                    ...
                    <div class="col-lg-6 z-1 mb-4 mb-lg-0">
                        <div class="card text-center border-0">
                            ...
                            <div class="card-body p-5">
                                <p class="lead">Submit your requests.</p>
                                <div class="mb-5">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="d-flex align-items-center justify-content-center mb-3">
                                        <i class="text-primary mr-2" data-feather="check-circle"></i>
                                        Unlimited amount of submit requests
                                    </li>
                                    <li class="d-flex align-items-center justify-content-center mb-3">
                                        <i class="text-primary mr-2" data-feather="check-circle"></i>
                                        Get paid from your client
                                    </li>
