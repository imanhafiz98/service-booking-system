            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.users.show', $user->id) }}">View Users</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('admin.users.edit', $user->id) }}">Edit Users</a></li>
                    </ol>
                </div>
            </div>
        </header>
