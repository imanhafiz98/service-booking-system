    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link" href="{{ route('admin.profiles.show', auth()->user()->id) }}">Profile</a>
                <a class="nav-link active ml-0" href="{{ route('admin.passwords.edit', auth()->user()->id) }}">Password</a>
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.passwords.update', Auth::user()->id) }}" method="POST">
                                @csrf
                                <!-- Form Group (username)-->
