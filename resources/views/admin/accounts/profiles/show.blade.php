    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <nav class="nav nav-borders">
                <a class="nav-link active ml-0" href="{{ route('admin.profiles.show', auth()->user()->id) }}">Profile</a>
                <a class="nav-link" href="{{ route('admin.passwords.edit', auth()->user()->id) }}">Password</a>
