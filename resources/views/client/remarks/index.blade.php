...
<body>
    ...
    <header class="page-header page-header-dark bg-gradient-primary-to-secondary pb-10">
                        <div class="container">
                            <div class="page-header-content pt-4">
                                ...
                                <ol class="breadcrumb mb-0 mt-4">
                                    <li class="breadcrumb-item"><a href="{{ route('client.services.index') }}">Requests</a></li>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                <div class="card-header">All Remarks  <a class="btn btn-primary" href="{{ route('client.remarks.create', $service) }}">Add Remark</a></div>
                <div class="card-body">
                    <div class="datatable">
